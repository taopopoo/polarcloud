...
/*
	...
	@success    bool    是否通过投票
*/
func (this *pollManager) Vote(class, params, replyHash string) (success bool) {
...
func (this *pollManager) removePross(class, param string) {
